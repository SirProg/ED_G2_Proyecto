package com.example.dsproyect_p1.modules.edit_company.view;
...
public class EditCompanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = findViewById(R.id.editCompanyName);
        residency = findViewById(R.id.editCompanyResidency);

        telephone = findViewById(R.id.editCompanyTelephone);
        email = findViewById(R.id.editCompanyEmail);
        address = findViewById(R.id.editCompanynAddress);
        socialMedia = findViewById(R.id.editCompanySocialMedia);
        associatedContacts = findViewById(R.id.editCompanyAssociatedContact);
        date = findViewById(R.id.editCompanyDate);
        loadData();
        addEditTelephone();
        addEditDate();
        addEditAddress();
    ...
    public void addEditTelephone(){
        ...
        buttonAgregarTelefono.setOnClickListener(
                v -> {
                    ...
                    Button botonEliminar = new Button(EditCompanyActivity.this);
